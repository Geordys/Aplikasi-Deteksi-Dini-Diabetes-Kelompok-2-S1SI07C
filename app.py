...
if data.isnull().values.any():
    data = data.dropna()
    st.success("✅ Poin 1: Missing Value telah dihapus.")
else:
    st.success("✅ Poin 1: Tidak ada missing value.")
...
st.success("✅ Poin 2: Data Cleaning (Encoding) selesai.")
...
st.success("✅ Poin 3: Outlier pada kolom Age telah ditangani (IQR Method).")

# 4. Data Reduction (Hapus Duplikat)
before = len(data)
data = data.drop_duplicates()
after = len(data)
st.success(f"✅ Poin 4: Data Reduction selesai. Data berkurang dari {before} menjadi {after} baris.")
...
st.success("✅ Poin 5: Normalization (Scaling) selesai.")
...
st.success(
    f"✅ Poin 6: Sampling selesai (80:20). "
...
st.success("✅ Poin 7: Encoding tambahan selesai. Semua data bertipe numerik.")
...
st.success("✅ Poin 8: Standarisasi data selesai.")
